		...
		function(a, b, c) {
			...
			return (
				...
				(k.removeCallback = function(a, b) {
					if (a)
						if (null == b) this._kill(null, a);
							...
							for (
								var c = this.getTweensOf(a, !1), d = c.length, e = this._parseTimeOrLabel(b);
								--d > -1;
						...
						(g.onStart = function() {
							f.target.paused(!0),
								f.vars.time === f.target.time() ||
									...
									f.isFromTo ||
									f
										.duration(Math.abs(f.vars.time - f.target.time()) / f.target._timeScale)
										.render(f.time(), !0, !0),
								c.onStart &&
									c.onStart.apply(c.onStartScope || c.callbackScope || f, c.onStartParams || []);
						}),
						f
					);
				}),
				...
				(k.render = function(a, b, c) {
					...
					if ((q !== p._time && (a += p._time - q), a >= r - e && a >= 0))
						...
						if (
							...
							(p._time = 0),
							a > -e && (a = 0),
							(0 !== q || (0 === s && w !== e && (w > 0 || (0 > a && w >= 0)) && !p._locked)) &&
						...
						0 === s && 0 > w && (k = !0),
							...
							p._locked ||
								...
								0 !== p._repeat &&
									...
									p._time > s
										? ((p._time = s), (a = s + 1e-4))
										: p._time < 0 ? (p._time = a = 0) : (a = p._time)));
					if (p._hasPause && !p._forcingPlayhead && !b) {
						...
						m &&
							((o =
								p._startTime +
								(p._reversed ? p._duration - m._startTime : m._startTime) / p._timeScale),
							m._startTime < s &&
					...
					if (p._cycle !== y && !p._locked) {
						...
						if (
							...
							b ||
								p._gc ||
								(p.vars.onRepeat && ((p._cycle = C), (p._locked = !1), p._callback('onRepeat'))),
							q !== p._time)
						)
							return;
						if (
							(A && ((p._cycle = y), (p._locked = !0), (q = z ? s + 1e-4 : -1e-4), p.render(q, !0, !1)),
							(p._locked = !1),
							p._paused && !x)
						)
							return;
					...
					if (
						...
						0 === t &&
							p.vars.onStart &&
							((0 === p._totalTime && p._totalDuration) || b || p._callback('onStart')),
						(n = p._time),
						n >= q)
					)
				...
				(k.totalDuration = function(b) {
					return arguments.length
						? -1 !== this._repeat && b ? this.timeScale(this.totalDuration() / b) : this
						: (this._dirty &&
				...
				(k.time = function(a, b) {
					...
					return (
						a > c && (a = c), this.totalTime(this._yoyo && 1 & d ? c - a + e : this._repeat ? a + e : a, b)
					);
				}),
				(k.repeat = function(a) {
						...
						return function(a, j, k) {
							...
							if (!v) {
								...
								(v.max = r - s),
									...
									(v.v = u =
										b.amount ||
										b.each * (t > u ? u - 1 : h ? ('y' === h ? u / t : t) : Math.max(t, u / t)) ||
										0),
									(v.b = 0 > u ? e - u : e);
							}
				...
				return (
					...
					(s.staggerTo = function(a, b, e, f, g, i, j, k) {
						var l,
							...
							u = e.cycle;
						for (
							'string' == typeof a && (a = c.selector(a) || a), a = a || [], h(a) && (a = p(a)), o = 0;
							o < a.length;
							o++
						)
							(l = m(e)),
					...
					(s.add = function(e, f, g, h) {
						...
						if (
							...
							(e._time || (!e._duration && e._initted)) &&
								...
								(!e._duration ||
									Math.abs(Math.max(0, Math.min(e.totalDuration(), j))) - e._totalTime > 1e-5) &&
									e.render(j, !1, !1)),
						...
						for (var f = [], g = this._first, h = 0; g; )
							g._startTime < e ||
								(g instanceof c
									? b !== !1 && (f[h++] = g)
									: (d !== !1 && (f[h++] = g),
										a !== !1 && ((f = f.concat(g.getChildren(!0, b, d))), (h = f.length)))),
								(g = g._next);
						return f;
					}),
					...
					(s._kill = function(a, b) {
						...
						for (
							var c = b ? this.getTweensOf(b) : this.getChildren(!0, !0, !1), d = c.length, e = !1;
							--d > -1;
